...
"""M38: NeuroPolicy on bci2a 4-class with the canonical session-T → session-E
...
Output: experiments/m38_canonical_bci2a/summary.json
"""
...
def main():
    ...
    out_dir = EXPERIMENTS_DIR / "m38_canonical_bci2a"
    out_dir.mkdir(parents=True, exist_ok=True)
    log.info("M38: %d subjects × %d seeds × %d configs = %d agents (canonical protocol)",
