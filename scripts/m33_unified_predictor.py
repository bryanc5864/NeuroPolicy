...
"""M33: Unified OPE-quality predictor — multivariate cross-dataset regression.

Combines per-subject OPE r from M17b (bci2b N=9), M19 (bci2a N=9),
and M31 (Lee2019 N=8) for a 3-dataset corpus of N=26 (subject, dataset)
...
Output: experiments/m33_unified_predictor/summary.json
"""
...
log = logging.getLogger("m33_predictor")

DATASETS = [
    ("bci2b", 3,  "m17_ope_loso/summary.json",       "m8_loso_bci2b/summary.json"),
    ("bci2a", 22, "m19_ope_loso_bci2a/summary.json", "m15_loso_bci2a/summary.json"),
    ("lee2019", 62, "m31_lee2019_extend/summary.json", None),  # use encoder_val_acc for Lee2019
]
...
def main():
    out_dir = ROOT / "experiments" / "m33_unified_predictor"
