# MIT License, 2026
""": LaBraM LOSO sweep on bci2b (foundation-model cross-subject test).
...
difference vs  is the encoder.

Output: experiments/labram_loso_bci2b/summary.json
"""
...
log = logging.getLogger("labram_loso_bci2b")
...
def main():
    ...
    out_dir = EXPERIMENTS_DIR / "labram_loso_bci2b"
    ...
    for held_out in subjects:
        ...
        # Single config: scalar CQL + CMDP eps=0.10 (mirrors  cmdp_eps0.1)
    ...
    # Aggregate
    log.info("\n===  AGGREGATE LOSO (LaBraM + scalar CQL + CMDP eps=0.10) ===")
