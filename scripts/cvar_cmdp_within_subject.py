# MIT License, 2026
""": exercise the CVaR-CQL and CMDP code paths within-subject.

Same data + buffer construction as within_subject_train (bci2b sub 4) but
trains four agents instead of one:
  scalar_a1                  : the  baseline (CQL alpha=1, no CMDP)
...
log = logging.getLogger("cvar_cmdp_within")
...
def main():
    ...
    # Identical encoder + split + buffer as  (seed 0 → reproducible)
    ...
    out_dir = EXPERIMENTS_DIR / "cvar_cmdp_within"
