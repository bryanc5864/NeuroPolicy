# MIT License, 2026
""": extend the within-subject ablation to BCI-IV-2a (4-class).

Same protocol as cvar_cmdp_within_subject.py, but on bci2a sub 3 (the strongest
 sanity-check subject — CSP+LDA 0.821) instead of bci2b sub 4. Tests:
...
Output: experiments/bci2a_within/summary.json
"""
...
log = logging.getLogger("bci2a_within")
...
def main():
    ...
    out_dir = EXPERIMENTS_DIR / "bci2a_within"
