...
"""Regenerate the M6 calibration figure from the saved results.json.

Standalone so it can be re-run if the main M6 script crashes after writing
...
RESULTS = ROOT / "experiments" / "m6_ope_calibration" / "results.json"
OUT_PNG = ROOT / "figures" / "m6_ope_calibration.png"
OUT_PDF = ROOT / "figures" / "m6_ope_calibration.pdf"
