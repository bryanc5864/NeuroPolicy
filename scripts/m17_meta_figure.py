...
"""Generate the M17b meta-correlation figure: subject decodability vs
cross-subject OPE Pearson r.

Visualises the headline meta-finding: corr(M8 EEGNet acc, M17 OPE r) = +0.827
...
def main():
    ...
    ax.set_xlabel("Held-out subject decodability (M8 EEGNet commit accuracy)")
