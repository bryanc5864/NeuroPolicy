...
"""Generate combined within-subject ablation table across M9 (bci2b),
M10 (bci2a), M11 (Lee2019). Outputs a markdown table to stdout.
"""
...
def main():
    m9 = load("m9_cvar_cmdp")
    m10 = load("m10_bci2a_within")
    m11 = load("m11_lee2019_within")
    ...
    print("|---|---|---|---:|---:|---:|---:|")
    for name, d, label in [
        ("bci2b sub 4 (2-class)", m9, "M9"),
        ("bci2a sub 3 (4-class)", m10, "M10"),
        ("Lee2019 sub 1 (2-class)", m11, "M11"),
    ]:
        if d is None:
