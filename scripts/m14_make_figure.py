...
"""Figure: paired per-subject return for M14 LaBraM vs M8 EEGNet on bci2b LOSO.
...
def main():
    ...
    ax.bar(x, [e8[s] for s in subs], w, label="EEGNet (M8)", color="C0", edgecolor="black")
    ax.bar(x + w, [e14[s] for s in subs], w, label="LaBraM e2e (M14)", color="C3", edgecolor="black")
