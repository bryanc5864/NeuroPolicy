# MIT License, 2026
""": FQE systematic-bias decomposition.

 surfaced that naive cross-subject FQE policy selection underperforms
a no-OPE default. Why? This script decomposes the FQE bias across the
combined N=18 held-out subjects ( bci2b +  bci2a) and 6 policies,
...
Output: experiments/fqe_bias_decomposition/summary.json + figures/fqe_bias_decomposition.png
"""
...
log = logging.getLogger("fqe_bias_decomposition")


def load_corpus():
    """Concatenate  +  per-subject OPE rows, joined with / acc."""
...
def main():
    out_dir = ROOT / "experiments" / "fqe_bias_decomposition"
    ...
    fig_path = ROOT / "figures" / "fqe_bias_decomposition.png"
