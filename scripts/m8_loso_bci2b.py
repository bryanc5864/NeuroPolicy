...
"""Milestone 8: LOSO sweep on BCI-IV-2b.
...
For each held-out subject in BCI-IV-2b (9 total):
  ...
  8. Save to experiments/m8_loso_bci2b/.

The PRE-TRAINING REVIEW GATE (R7) has been passed; this run is unblocked.
"""
...
def run_loso(configs: list[AgentConfig], subjects: list[int], dataset_key: str = "bci2b"):
    ...
    out_dir = EXPERIMENTS_DIR / "m8_loso_bci2b"
