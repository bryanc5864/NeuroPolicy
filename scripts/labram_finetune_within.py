# MIT License, 2026
""": LaBraM end-to-end fine-tuning on bci2a sub 3.

The frozen-LaBraM result of  showed the pretrained features alone do not
...
Output: experiments/labram_finetune_within/summary.json
"""
...
log = logging.getLogger("labram_finetune_within")
...
def main():
    ...
    out_dir = EXPERIMENTS_DIR / "labram_finetune_within"
