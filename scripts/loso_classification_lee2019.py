# MIT License, 2026
""": Lee2019 (62-channel) LOSO classification at scale — SOTA-by-novelty.
...
log = logging.getLogger("loso_classification_lee2019")
...
def main():
    ...
    out_dir = EXPERIMENTS_DIR / "loso_classification_lee2019"
    ...
    # Aggregate
    log.info("\n===  AGGREGATE LOSO Lee2019 (EEGNet + scalar CQL + CMDP eps=0.10) ===")
