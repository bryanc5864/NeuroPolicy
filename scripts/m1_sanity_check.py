...
"""Milestone 1 sanity check: within-subject CSP+LDA on a small subset of subjects.

Per RESEARCH_PLAN.md Milestone 1, we verify the data pipeline is sound by
...
Output: experiments/m1_sanity/m1_csp_lda_results.json
"""
...
log = logging.getLogger("m1_sanity")
...
def main():
    out_dir = EXPERIMENTS_DIR / "m1_sanity"
    out_dir.mkdir(parents=True, exist_ok=True)
    out_path = out_dir / "m1_csp_lda_results.json"
