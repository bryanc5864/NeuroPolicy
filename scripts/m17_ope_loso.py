...
"""M17: OPE calibration extended to cross-subject (LOSO held-out).

Generalizes M6's within-subject OPE calibration (Pearson r=0.860) to
...
Output: experiments/m17_ope_loso/summary.json (per-subject + aggregate)
...
log = logging.getLogger("m17_ope_loso")
