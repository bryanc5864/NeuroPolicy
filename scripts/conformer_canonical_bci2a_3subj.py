# MIT License, 2026
""": EEG-Conformer (Song et al. 2023) mandatory classification on bci2a
4-class — canonical session-T → session-E protocol — SOTA-push experiment.

Goal: beat our  EEGNet-mandatory baseline (0.821 ± 0.07) and push toward
...
direct comparison to  EEGNet-mandatory and to published literature.

Output: experiments/conformer_canonical_bci2a_3subj/summary.json
"""
...
log = logging.getLogger("conformer_canonical_bci2a_3subj")
...
def main():
    ...
    out_dir = EXPERIMENTS_DIR / "conformer_canonical_bci2a_3subj"
