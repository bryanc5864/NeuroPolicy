...
"""M27: Action-utilization analysis across all trained agents.
...
Sources (all single-agent variants across datasets):
  - M5  bci2b sub 4 within (scalar CQL)
  - M9  bci2b sub 4 within (4 variants: scalar/scalar+CMDP/CVaR/CVaR+CMDP)
  - M10 bci2a sub 3 within (same 4 variants)
  - M11 Lee2019 sub 1 within (same 4 variants)
  - M8  bci2b LOSO per-subject (9 × 3 configs)
  - M15 bci2a LOSO per-subject (9 × 3 configs)

Output: experiments/m27_action_utilization/summary.json + a per-action
...
log = logging.getLogger("m27_action")
...
def main():
    out_dir = ROOT / "experiments" / "m27_action_utilization"
    out_dir.mkdir(parents=True, exist_ok=True)

    # Map experiment dir → label
    targets = [
        ("m9_cvar_cmdp/summary.json", "M9_bci2b_within_sub4"),
        ("m10_bci2a_within/summary.json", "M10_bci2a_within_sub3"),
        ("m11_lee2019_within/summary.json", "M11_lee2019_within_sub1"),
        ("m12_cvar_sweep/summary.json", "M12_cvar_sweep_bci2b_sub4"),
        ("m8_loso_bci2b/summary.json", "M8_loso_bci2b"),
        ("m15_loso_bci2a/summary.json", "M15_loso_bci2a"),
        ("m13b_labram_finetune/summary.json", "M13b_labram_bci2a_sub3"),
        ("m14_labram_loso_bci2b/summary.json", "M14_labram_loso_bci2b"),
        ("m16_labram_loso_bci2a/summary.json", "M16_labram_loso_bci2a"),
    ]
