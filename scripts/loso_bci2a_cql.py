# MIT License, 2026
""": LOSO sweep on BCI-IV-2a (9 subjects, 4-class).

Same protocol as  (bci2b LOSO with EEGNet stand-in encoder + scalar CQL +
CMDP eps=0.10), but on bci2a (4-class, 22 channels). Closes the multi-
dataset Pareto frontier claim from RESEARCH_PLAN.md §1.0.

Output: experiments/loso_bci2a/summary.json
"""
...
log = logging.getLogger("loso_bci2a")
...
def main():
    ...
    out_dir = EXPERIMENTS_DIR / "loso_bci2a"
    ...
    for held_out in subjects:
        ...
        # Encoder pretrain on training subjects (matches  protocol)
    ...
    # Aggregate
    log.info("\n===  AGGREGATE LOSO bci2a (EEGNet + scalar CQL + CMDP eps=0.10) ===")
