# MIT License, 2026
"""Combined meta-correlation figure: bci2b () + bci2a () cross-subject
...
def main():
    bci2b = load(ROOT / "experiments" / "loso_bci2b" / "summary.json",
                  ROOT / "experiments" / "ope_loso_bci2b" / "summary.json",
                  "cmdp_eps0.1")
    bci2a = load(ROOT / "experiments" / "loso_bci2a" / "summary.json",
                  ROOT / "experiments" / "ope_loso_bci2a" / "summary.json",
                  "cmdp_eps0.1")
    ...
    ax.set_title("Cross-subject OPE calibration tracks decodability\n"
                 "Replicates across bci2b () and bci2a ()", fontsize=11)
