...
"""M11: extend the within-subject ablation to Lee2019 (62-ch, 2-class).

Same protocol as m9_cvar_cmdp_within.py, but on Lee2019 (54-subject MI corpus,
...
Output: experiments/m11_lee2019_within/summary.json
"""
...
log = logging.getLogger("m11_lee2019")
...
def main(subject_id: int = 1):
    ...
    out_dir = EXPERIMENTS_DIR / "m11_lee2019_within"
