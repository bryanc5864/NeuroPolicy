# MIT License, 2026
"""NeuroPolicy with EEG-Conformer encoder on canonical bci2a 4-class.
...
Output: experiments/neuropolicy_canonical_bci2a_conformer/summary.json
"""
...
log = logging.getLogger("neuropolicy_conformer_canonical")
...
def main():
    ...
    out_dir = EXPERIMENTS_DIR / "neuropolicy_canonical_bci2a_conformer"
    ...
    log.info("\n\n=== CROSS-SUBJECT AGGREGATE (Conformer encoder, N=3 subj) ===")
    cs = {}
    for cfg in CONFIGS:
        name = cfg["name"]
