# MIT License, 2026
"""Validate the OPE deployment rule actionably.

Subject decodability predicts cross-subject OPE calibration quality
(Pearson r ~ 0.6-0.8). This script tests whether *using* this finding
to gate FQE-based policy selection actually improves outcomes vs naive
FQE-based selection.
...
Output: experiments/deployment_validation/summary.json
"""
...
log = logging.getLogger("deployment_validation")


def evaluate_strategy(per_subject, dec_acc, threshold, default_policy="agent_T0"):
...
def main():
    out_dir = ROOT / "experiments" / "deployment_validation"
