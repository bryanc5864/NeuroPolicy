...
Output: experiments/conformer_canonical_bci2a_all9/summary.json
"""
...
log = logging.getLogger("conformer_canonical_bci2a_all9")
...
def main():
    ...
    out_dir = EXPERIMENTS_DIR / "conformer_canonical_bci2a_all9"
