...
Under the standard \bcia{} 4-class evaluation protocol on the
canonical 3-subject panel ($\{1, 3, 7\}$), the trained agent
reaches $86.2\!\pm\!5.8\%$ commit accuracy at
...
weakest-decoding subject (S07). Extended to all 9 \bcia{}
subjects $\times$ 5 seeds (Table~\ref{tab:sota}), commit accuracy
drops to $0.746\!\pm\!0.12$ at $24.9$~b/m: the 3-subject panel
matches \emph{good-decoding} subjects ($1$, $3$, $7$, $8$ all
$\ge\!0.84$), while subjects whose encoder val-accuracy is
$\le\!0.70$ ($2$, $5$, $6$, $9$) cap at $\le\!0.69$ regardless of
the agent. This stratification cleanly localises the bottleneck
to encoder quality, not to the selective-decoder mechanism. The agent occupies the
