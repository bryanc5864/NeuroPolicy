...
$34.2$~bits/min~\itr{} with \textsc{Defer} as a \emph{learned}
action; the \itr{} is roughly $2\times$ the typical value reported
on this benchmark, gained by deferring uncertain trials instead of
guessing wrong. A monotonic electrode-count to
