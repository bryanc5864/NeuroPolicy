...
$34.2$~bits/min~\itr{} with wrong-commit rate $\le 5\%$, occupying
the high-accuracy point of the accuracy--throughput Pareto frontier
we benchmark: head-to-head against confidence-threshold
EEGNet baselines on the same data, threshold-tuned variants
reach higher \itr{} ($66$--$850$~b/m) but at much lower commit
accuracy ($0.56$--$0.70$); the mandatory EEGNet baseline reaches
$0.82$ accuracy at only $20.7$~b/m. The agent learns to commit
only when the encoder is confident, giving the best
accuracy / wrong-rate operating point in this regime. A monotonic electrode-count to
