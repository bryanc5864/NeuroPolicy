...
augmentation ($N_s\!=\!8$), 9 subjects $\times$ 3 seeds. The mean
...
block) gives commit accuracy $0.746\!\pm\!0.12$ at $24.9\!\pm\!11.3$~b/m
(CVaR+CMDP, 9 subj $\times$ 5 seeds). The per-subject results
stratify clearly into two groups: subjects with encoder val-acc
$\ge\!0.80$ ($1$, $3$, $7$, $8$) reach commit accuracy $0.84$--$0.89$
at $32$--$42$~b/m, matching the 3-subject headline; subjects with
encoder val-acc $\le\!0.70$ ($2$, $5$, $6$, $9$) cap at commit
accuracy $0.60$--$0.69$ at $11$--$18$~b/m regardless of agent
configuration. The CMDP commit-error constraint
...
(Fig.~\ref{fig:cvar_alpha}). Mean commit accuracy is approximately
