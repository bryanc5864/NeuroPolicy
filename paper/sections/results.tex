...
Left: aggregate mean$\pm$std on episode return / commit accuracy /
\itr{} / decision latency. Right: paired one-sided Wilcoxon test
\nettype{} ($\alpha\!=\!1$) vs.\ each baseline.}
\label{tab:loso_baselines}
\footnotesize
\setlength{\tabcolsep}{3pt}
\begin{tabular}{l r r r r | r r r}
\toprule
Method & Return & Acc & \itr{}(b/m) & Lat.(s) & $\Delta$ ret & Wins & $p$ \\
\midrule
random              & $-1.58$       & $0.51$ & $0.2$  & $0.2$  & $+0.21$ & $6/9$ & $0.10$ \\
CSP+LDA fixed       & $-1.80$       & $0.58$ & $0.8$  & $3.0$  & $\mathbf{+0.44}$ & $8/9$ & $\mathbf{0.037}$ \\
\eegnet{} fixed     & $-1.39$       & $0.65$ & $1.9$  & $3.0$  & $+0.02$ & $4/9$ & $0.29$ \\
\eegnet{}+thr$0.55$ & $-1.41$       & $0.60$ & $\mathbf{128.2}$ & $0.02$ & $+0.04$ & $4/9$ & $0.37$ \\
\eegnet{}+thr$0.65$ & $-1.35$       & $0.61$ & $23.6$ & $0.15$ & $-0.01$ & $4/9$ & $0.59$ \\
\eegnet{}+thr$0.75$ & $\mathbf{-1.29}$ & $0.63$ & $10.6$ & $0.51$ & $-0.08$ & $4/9$ & $0.79$ \\
\midrule
\nettype{}          & $-1.37$       & $\mathbf{0.65}$ & $1.9$ & $3.0$ & --- & --- & --- \\
\bottomrule
\end{tabular}
\end{table}
...
$\epsilon\!=\!0.10$: \textbf{commit accuracy
$0.696\!\pm\!0.104$ vs random $0.481$, $10/10$ subjects beat random,
$\Delta_{\text{ret}}\!=\!+0.668\!\pm\!0.391$, paired Wilcoxon
$p\!=\!0.001$ (1-sided)} (Fig.~\ref{fig:lee2019_loso}) --- the
first statistically significant LOSO improvement obtained on any
of the three datasets, completing the channel-count to
LOSO-significance trend
(Fig.~\ref{fig:channel_sig}: $p\!=\!0.10$, $0.15$, $0.001$ on the
$\{3, 22, 62\}$-channel datasets).
