...
action space $\{\text{commit-class}_1, \ldots, \textsc{Defer},
\textsc{Request\_Recal}, \textsc{Abstain}\}$, train a Conservative
Q-Learning (\cql{}) agent on logged trajectories from two behavior
policies, and validate the resulting policies with a calibrated
fitted-Q evaluator against on-policy Monte-Carlo ground truth.
...
classification benchmark for offline-RL BCI, completing a
